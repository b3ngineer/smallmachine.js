;var smallmachine = (function(core) {
	...
	Rules.prototype.relatesTo = function(TermA, TermB) {
		...
		this._ontology[this._value][TermA._value] = new this._ontology.Term(TermA); // isolate relationship scope
		this._ontology[this._value][TermA._value][TermB._value] = TermB; // put object property in scope
		this._ontology[this._value][TermB._value] = TermB; // sugar for including property as child
		...
		for (var field in TermB) {
			...
			this._ontology[this._value][TermA._value][field] = TermB[field]; // link subclasses in scope
			this._ontology[this._value][field] = TermB[field]; // sugar for linking subclasses as children
