...
this[b];this._inferencer._rules.sort(function(a,c){return a._priority-c._priority});for(c=0;c<this._inferencer._rules.length;c++)d=this._inferencer._rules[c],d._fn.apply(a,d._args);for(c=0;c<this._activators.length;c++)this._activators[c].fn(a);return a};e.Ontology=l;var s=function(a,b,d){this._fn=b;this._args=d;this._priority=a;return this};b.prototype.isA=function(a){this._rules.push(new s(1,n,[this._term._value,a._term._value]));return this};b.prototype.relatesTo=function(c,b){this._rules.push(new s(10,
a,[this._term._value,c._term._value,b._term._value]));return this};b.prototype.hasDomain=function(a){this._rules.push(new s(3,h,[this._term._value,a._term._value]));return this};b.prototype.hasRange=function(a){this._rules.push(new s(2,g,[this._term._value,a._term._value]));return this};e.alsoBehavesLike(m,b);e.typeMask=function(a,b){var d=[],e;for(e in b)b.hasOwnProperty(e)&&("undefined"===typeof a||"undefined"===typeof a[e]?d.push(e):"undefined"!==typeof a[e]&&typeof a[e]!==b[e]&&!0!==b[e]&&d.push(e));
