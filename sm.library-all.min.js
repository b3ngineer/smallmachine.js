var smallmachine=function(d){"function"!==typeof Object.getPrototypeOf&&(Object.getPrototypeOf="object"===typeof"test".__proto__?function(a){return a.__proto__}:function(a){return a.constructor.prototype});var a=function(a,c){for(var d=0;d<c.dependencies.length;d++){for(var b=!1,e=0;e<a.length;e++)if(c.dependencies[d]==a[e].title){b=!0;break}if(!b)return c.dependencies[d]}return null};d=function(n,c){"undefined"===typeof n&&d.error(Error("Missing required parameter for smallmachine constructor: one or more instances of type [object Ontology]"));
for(var b=[].concat(n),e="",g=0;g<b.length;g++)"function"!==typeof b[g].ofType||!b[g].ofType("Ontology")?"undefined"!==typeof d.ontology[b[g]]&&(e=e+b[g]+",",b[g]=d.ontology[b[g]]):e+=b[g].title;e=new d.Ontology(e.substring(0,e.length-1));for(g=0;g<b.length;g++){for(var m in b[g])b[g].hasOwnProperty(m)&&"function"===typeof b[g][m].ofType&&b[g][m].ofType("Proxy")&&e.addTerm(b[g][m]._term._value);for(var f=0;f<b[g]._inferencer._rules.length;f++)e._inferencer._rules.push(b[g]._inferencer._rules[f]);
for(f=0;f<b[g]._activators.length;f++){var h=a(b,b[g]._activators[f]);null!==h&&d.error(Error("Cannot wire-in ontology with missing activator dependency on '"+h+"'"));e.registerActivator(b[g]._activators[f]);e._activators.sort(function(a,n){if(a.title==n.title)return 0;for(var c=0;c<a.dependencies.length;c++)if(n.title==a.dependencies[c])return 1;for(c=0;c<n.dependencies.length;c++)if(a.title==n.dependencies[c])return-1;return 0})}}return e.getModel(c)};d.alsoBehavesLike=function(a,c){("undefined"===
typeof a||"undefined"===typeof c)&&d.error(Error("Cannot mixin with an undefined object"));for(var b in c)if(c.hasOwnProperty(b)&&!(0==b.indexOf("_")||"initializer"===b))if("undefined"!==typeof a[b]){if("undefined"!==typeof c[b].prototype){if("undefined"!==typeof c[b].prototype.initializer&&!0==c[b].prototype.initializer)continue;var e="undefined"!==typeof c[b].prototype.virtual?c[b].prototype.virtual:!1}var g="undefined"!==typeof a[b].prototype?a[b].prototype.virtual:!1;if(!g||!e)g&&(a[b]=c[b])}else a[b]=
c[b];"undefined"!==typeof c.prototype&&("undefined"===typeof a.prototype&&(a.prototype={}),d.alsoBehavesLike(a.prototype,c.prototype))};d.error=function(a,c){if("undefined"!==typeof c&&"function"===typeof c.handleError)c.handleError(a);else if("function"===typeof d.handleError)d.handleError(a);else throw a;};var l=function(a){var c=16*Math.random()|0;return("x"==a?c:c&3|8).toString(16)};d.getGuid=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,l)};d.CONCEPT="concept";d.RELATIONSHIP=
"relationship";var h=function(a,c){this._term=a;this._rules=c._rules;return this};h.prototype.getType=function(){return"[object Proxy]"};h.prototype.ofType=function(a){return"Proxy"===a||"function"===typeof a.getType&&a.getType()===this.getType()};var e=function(){return this};e.prototype.relate=function(a){"undefined"===typeof this._relatesTo&&(this._relatesTo=[]);for(var c=!1,b=0;b<this._relatesTo.length;b++)if(this._relatesTo[b]._id==a._id){c=!0;break}c||this._relatesTo.push(a)};e.prototype.getType=
function(){return"[object Term]"};e.prototype.ofType=function(a){return"Term"===a||"function"===typeof a.getType&&a.getType()===this.getType()};d.Behavior=function(a){this.title=a;return this};d.Ontology=function(a){this.title=a;this._inferencer=new f;this._activators=[];this._term=function(a){this._id=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(a){var c=16*Math.random()|0;return("x"==a?c:c&3|8).toString(16)})}();"undefined"!==typeof a._value&&"undefined"!==typeof a._type?
(this._value=a._value,this._type=a._type):(this._value=a,this._type=null);return this};return this};d.Ontology.prototype.getType=function(){return"[object Ontology]"};d.Ontology.prototype.addTerm=function(a){if("undefined"!==typeof this[a])return this;var c=this._term;c.prototype.relate=e.prototype.relate;c.prototype.getType=e.prototype.getType;c.prototype.ofType=e.prototype.ofType;c=new c(a);this[a]=new h(c,this._inferencer);return this};d.Ontology.prototype.registerActivator=function(a,c){"undefined"===
typeof c&&(c=[]);"function"!==typeof a&&"function"===typeof a.getType&&"[object Activator]"===a.getType()?this._activators.push(a):this._activators.push({fn:a,title:this.title,dependencies:c,getType:function(){return"[object Activator]"}})};d.Ontology.prototype.getModel=function(a){var c=new function(a){return this},b=[];if("undefined"!==typeof a){b=b.concat(a);for(a=0;a<b.length;a++)if("undefined"===typeof b[a]&&d.error("One or more [behaviors] arguments were supplied to the smallmachine constructor that are 'undefined'; error creating object model"),
...
b._fn.apply(c,b._args);for(a=0;a<this._activators.length;a++)this._activators[a].fn(c);return c};var f=function(){this._term={_value:null};this._rules=[];return this},b=function(a,c,b){this._fn=c;this._args=b;this._priority=a;return this};f.prototype.isA=function(a){this._rules.push(new b(1,g,[this._term._value,a._term._value]));return this};f.prototype.relatesTo=function(a,e){this._rules.push(new b(10,c,[this._term._value,a._term._value,e._term._value]));return this};f.prototype.hasDomain=function(a){this._rules.push(new b(3,
m,[this._term._value,a._term._value]));return this};f.prototype.hasRange=function(a){this._rules.push(new b(2,q,[this._term._value,a._term._value]));return this};d.alsoBehavesLike(h,f);var c=function(a,c,b){a=this[a];var e=this[c],g=this[b];e._type===d.CONCEPT?d.error(Error("Cannot define a relationship with a concept type: "+e._value)):null===e._type&&(e._type=d.RELATIONSHIP);g._type===d.RELATIONSHIP?d.error(Error("Cannot create a relationship with a relationship type: "+g._value)):null===g._type&&
(g._type=d.CONCEPT);a._type===d.RELATIONSHIP?d.error(Error("Cannot create a relationship from a relationship type: "+a._value)):null===a._type&&(a._type=d.CONCEPT);"undefined"===typeof a[c]&&(a[c]=new a.constructor(e));"undefined"===typeof a[c][b]&&(a[c][b]=g);"undefined"===typeof a[b]&&(a[b]=g);g.relate(a[c]);for(var f in g)g.hasOwnProperty(f)&&(g[f].getType&&"[object Term]"===g[f].getType())&&("undefined"===typeof a[c][f]&&(a[c][f]=g[f]),"undefined"===typeof a[f]&&(a[f]=g[f]),g[f].relate(a[c]))},
g=function(a,c){var b=this[a],e=this[c];e._type===d.RELATIONSHIP?d.error(Error("Cannot apply isA to a relationship type: "+e._value)):null===e._type&&(e._type=d.CONCEPT);b._type===d.RELATIONSHIP?d.error(Error("Cannot apply isA to a relationship type: "+b._value)):null===b._type&&(b._type=d.CONCEPT);"undefined"===typeof e[a]&&(e[a]=b)},q=function(a,c){var b=this[a],e=this[c];e._type===d.RELATIONSHIP?d.error(Error("Cannot apply hasRange to a relationship type: "+e._value)):null===e._type&&(e._type=
d.CONCEPT);b._type===d.CONCEPT?d.error(Error("Cannot assign hasRange from a concept type: "+b._value)):null===b._type&&(b._type=d.RELATIONSHIP);"undefined"===typeof b[c]&&(b[c]=e);e.relate(b);for(var g in e)if(e.hasOwnProperty(g)&&e[g].getType&&"[object Term]"===e[g].getType()){var f=e[g]._value;"undefined"===typeof b[f]&&(b[f]=e[g]);e[g].relate(b)}},m=function(a,c){var b=this[a],e=this[c];e._type===d.RELATIONSIP?d.error(Error("Cannot apply hasRange to a relationship type: "+e._value)):null===e._type&&
(e._type=d.CONCEPT);b._type===d.CONCEPT?d.error(Error("Cannot assign hasRange from a concept type: "+b._value)):null===b._type&&(b._type=d.RELATIONSHIP);"undefined"===typeof e[a]&&(e[a]=b)};d.typeMask=function(a,c){var b=[],e;for(e in c)c.hasOwnProperty(e)&&("undefined"===typeof a||"undefined"===typeof a[e]?b.push(e):"undefined"!==typeof a[e]&&typeof a[e]!==c[e]&&!0!==c[e]&&b.push(e));return 0===b.length?null:b};return d}(smallmachine||{});(function(d){var a=new d.Ontology("sm.properties");a.addTerm("property");a.addTerm("type");a.addTerm("ontology");a.addTerm("behavior");a.addTerm("hasMemberType");a.addTerm("hasMember");a.addTerm("Ontology");a.addTerm("Behavior");a.addTerm("Constructor");a.addTerm("Null");a.ontology.isA(a.property);a.behavior.isA(a.property);a.Ontology.isA(a.type);a.Behavior.isA(a.type);a.Constructor.isA(a.type);a.Null.isA(a.type);a.ontology.relatesTo(a.hasMemberType,a.Ontology);a.behavior.relatesTo(a.hasMemberType,
...
b&&(this.nodeGroups++,this.lastNodeGroup=b);this.width=this.width+40+d;var e=parseFloat(a.height);this.height=this.height<e?e:this.height;this.x=this.x-20-0.5*d;for(e=d=0;e<a.edges.length;e++)a.edges[e].label.length>d&&(d=a.edges[e].label.length);6<d&&(d=this.height+10*(d-6),d>this.height&&(this.height=d));this.nodes.push({node:a,nodeGroup:b})};h.prototype.finalize=function(a){if("undefined"===typeof a||0>a)a=0;a*=0.5;for(var d=null,b=0,e=0;e<this.nodes.length;e++)null===d?d=this.nodes[e].nodeGroup:
this.nodes[e].nodeGroup!=d&&(b++,d=this.nodes[e].nodeGroup),this.nodes[e].node.x=this.x+(40*e+40*b)+this.nodes[e].node.width*e+a,this.nodes[e].node.y=this.y};var e=function(a){this.paper=a;this.width=parseFloat(a.width);this.height=parseFloat(a.height);this.finalWidth=this.width;this.finalHeight=this.height;this.sectors=[];return this};e.prototype.addToSector=function(a,d,b){var e=this.sectors[d];"undefined"===typeof e&&(e=new h(this.sectors[d-1],this.width,this.height,b),this.sectors[d]=e);e.add(a,
b)};e.prototype.finalize=function(){for(var a=0;a<this.sectors.length;a++)this.sectors[a].width+=40*this.sectors[a].nodeGroups,this.sectors[a].width>this.finalWidth&&(this.finalWidth=this.sectors[a].width);for(a=0;a<this.sectors.length;a++)this.sectors[a].finalize(this.finalWidth-this.width)};var f=function(a,d,b,e,h,k){e.addToSector(a,h++,k);for(k=0;k<a.edges.length;k++)f(d[b[a.edges[k].id]],d,b,e,h,a.id)};a.registerActivator(function(a){a.paint.subscribe(function(b){if(null===d.typeMask(b.value,
{length:!0,sort:"function"}))return function(h){h=b.value;var m=new d.type.NamedValue("sm.flowchart","root",null);a.get.publish(m);var l=new d.type.NamedValue("sm.raphaeljs","paper",null);a.get.publish(l);for(var k=new e(l.value),m=m.value,p={},r=h[0],s=0;s<h.length;s++)p[h[s].id]=s,h[s].id===m&&(r=h[s]);f(r,h,p,k,0,r.id);k.finalize();l.value.setSize(1.05*k.finalWidth,1.05*k.finalHeight);return!1}})},["sm.channels","sm.nodes","sm.raphaeljs"]);try{d.ontology.extendedBy(a)}catch(b){d.error(Error("Could not extend the smallmachine.ontology property with the 'sm.nodes' ontology: "+
