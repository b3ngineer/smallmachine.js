...
a[d];"undefined"!==typeof a.prototype&&("undefined"===typeof f.prototype&&(f.prototype={}),e.alsoBehavesLike(f.prototype,a.prototype))};e.error=function(a,d){if("undefined"!==typeof d&&"function"===typeof d.handleError)d.handleError(a);else if("function"===typeof e.handleError)e.handleError(a);else throw a;};e.CONCEPT="concept";e.RELATIONSHIP="relationship";var l=function(a,d){this._term=a;this._rules=d._rules;return this};l.prototype.getType=function(){return"[object Proxy]"};l.prototype.ofType=
