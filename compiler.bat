...
"C:\Program Files (x86)\Java\jre7\bin\java.exe" -jar lib/compiler.jar --compilation_level=SIMPLE_OPTIMIZATIONS --js=src/sm.core.js --js=src/ontologies/sm.properties.js --js=src/ontologies/sm.channels.js --js=src/behaviors/sm.Channel.js --js=src/behaviors/sm.Extension.js --js_output_file=packages/channels/sm.library.min.js

"C:\Program Files (x86)\Java\jre7\bin\java.exe" -jar lib/compiler.jar --compilation_level=SIMPLE_OPTIMIZATIONS --js=src/sm.core.js --js=src/ontologies/sm.properties.js --js=src/ontologies/sm.channels.js --js=src/behaviors/sm.Channel.js --js=src/behaviors/sm.Extension.js --js_output_file=packages/nodes/sm.library.min.js
